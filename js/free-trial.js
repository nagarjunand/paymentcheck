$(document).ready(function(){
    ...
    //		$(window).scrollTop($('#form_error').offset().top);
        ...
        package_info = {
          ...
          "ordersource": 'Corefactors Website',
          //"API_KEY":'6644d52e-502f-4045-9e13-cbd7e32e306a',  //Naga local API
          "API_KEY":'53f71c9f-0282-47f7-934e-4d2dc5e3b273',   // Test Server API key
          "USER": '2',
          "updatecontact": "true",
        }
        $.post("https://test2.td.corefactors.in/api/checkuser/", package_info,  function( data ) {
          package_info = {'create_order':'true', 'package_info' : package_info, 'ordersource':'Corefactors Website', 'payment_id':findGetParameter('payment_id')}
        $.post("https://test2.td.corefactors.in/PaymentProcessOrder/", JSON.stringify(package_info),  function( data ) {
          window.location.replace("payment.html?payment_id="+findGetParameter('payment_id'));
            }).fail(function(e) {
     ...
     /*   $.ajax({
         ...
         dataType: "json",
          data:{
            ...
            company: $('#company_name').val(),
            ordersource: 'Corefactors Website',
            API_KEY:'6644d52e-502f-4045-9e13-cbd7e32e306a',
            USER: '2',
          },
          success: function (json) {
            console.log(json);
            window.location.replace("payment.html?payment_id=124")
